...
import com.josalero.keycloak.providers.SimplePlatformProvider;
...
public class Config {
	...
	ServletRegistrationBean<HttpServlet30Dispatcher> keycloakJaxRsApplication() {
		...
		servlet.addInitParameter(ResteasyContextParameters.RESTEASY_SERVLET_MAPPING_PREFIX, properties.getServer("context-path"));
		servlet.addInitParameter(ResteasyContextParameters.RESTEASY_USE_CONTAINER_FORM_PARAMS, "true");
		servlet.addUrlMappings(properties.getServer("context-path") + "/*");
	...
	FilterRegistrationBean<RequestFilter> keycloakSessionManagement() {
		...
		filter.addUrlPatterns(properties.getServer("context-path") + "/*");
		return filter;
	}
